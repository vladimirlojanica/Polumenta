...
def Polumente(broj=1):
	""" Функција која генерише једног или више полументи (до 100) и враћа их као листу  	
	Args:
...
def rodiPolumentu(ime):
	""" Функција која враћа да ли ће се у милион циклуса и у ком тачно родити дати Полумента   	
	Args:
		ime: име Полументе 
	Returns:
